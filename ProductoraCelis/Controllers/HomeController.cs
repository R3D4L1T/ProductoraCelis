    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult RealizarPago()
        {
            ...
            var carrito = string.IsNullOrEmpty(carritoJson)
                ? new List<Carrito>()
                : JsonConvert.DeserializeObject<List<Carrito>>(carritoJson);
        ...
        public IActionResult Comprobante(int idCompra)
        {
            ...
            {
                IdCompra = compra.IdCompra,
                Carrito = compra.DetallesCompra.Select(d => new Carrito
                {
                ...
                Total = compra.DetallesCompra.Sum(d => d.PrecioUnitario * d.Cantidad),
